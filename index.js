...
//each new function creates their own scope, everything inside that scope is enclosed, or not available to those outside of their scope
//since nestedFunction is in the same function ie. scope as internals declaration it has access to it
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(/*Your Code Here*/){
    const lCName = zooAnimals.map(item => {return item.animal_name.toLowerCase()});
    return lCName;
  }
  ...
  */
  ...
  function lowPopulationAnimals(/*Your Code Here*/){
    return zooAnimals.filter(item => {return item.population < 5});
  }
